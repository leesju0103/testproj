namespace Calculator
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            tableLayoutPanel1.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 20F));
            tableLayoutPanel1.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 20F));
            tableLayoutPanel1.Controls.Add(button_equal, 4, 2);
            ...
            // button_equal
            // 
            button_equal.Dock = DockStyle.Fill;
            button_equal.Location = new Point(215, 95);
            button_equal.Margin = new Padding(3, 3, 0, 3);
            button_equal.Name = "button_equal";
            tableLayoutPanel1.SetRowSpan(button_equal, 2);
            button_equal.Size = new Size(50, 88);
            button_equal.TabIndex = 21;
            button_equal.Text = "=";
